...
public:
    ...
    std::unique_ptr<tridiagonal_matrix> clone() {
        auto clone = std::make_unique<tridiagonal_matrix>(
            m_down,
            m_upper,
            m_middle
        );
...
int main()
{
    ...
    std::cout << "down ";
    for (auto it : matrix->m_down) {
        std::cout << it << " ";
    }
    std::cout << std::endl;

    std::cout << "upper ";
    for (auto it : matrix->m_upper) {
        std::cout << it << " ";
    }
    std::cout << std::endl;

    std::cout << "middle ";
    for (auto it : matrix->m_middle) {
        std::cout << it << " ";
    }
    std::cout << std::endl;

    std::cout << "==============C L O N E==============" << std::endl;

    std::cout << "Matrix_clone: " << std::endl;
    std::cout << matrix_clone << std::endl;

    std::cout << "down ";
    for (auto it : matrix_clone->m_down) {
        std::cout << it << " ";
    }
    std::cout << std::endl;

    std::cout << "upper ";
    for (auto it : matrix_clone->m_upper) {
        std::cout << it << " ";
    }
    std::cout << std::endl;

    std::cout << "middle ";
    for (auto it : matrix_clone->m_middle) {
        std::cout << it << " ";
    }
    std::cout << std::endl;
